...
def run_cmd(
    policy: str = typer.Option(
        "replication.yml",
        "--policy",
        help="Policy filename (resolved against bundled policies) or full path. Default: replication.yml (bundled).",
    ),
    ...
    console.print(f"[green]✓[/green] replicate ({mode_label}) — policy={policy_path.name}")
